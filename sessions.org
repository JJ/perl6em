...
Maybe we are out-zenning a bit with doing 7 sessions without a real hint of what Perl6, or for that matter any other
 language, is about. Except for the interpreter, that is. 
