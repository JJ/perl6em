...
A bit of homework: create a sequence of apartment coordinates combining house number + floor + letter. To be turned in in a Repo.
...
the documentation, and on how to generate better-quality documents
