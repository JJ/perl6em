...
`vim`. Here you go, a mention. Or [Atom](http://atom.io). You can
definitely use them, if that is your
thing. [[https://github.com/perl6/atom-language-perl6#how-do-i-use-this][Perl6 scripts look positively pretty]] with the Atom Perl 6
